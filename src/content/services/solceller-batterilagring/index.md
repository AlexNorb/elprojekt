...
description: "Säkra solceller och batterilagring. Installerat av lokal elfirma och riktiga takläggare."
icon: "bolt"
features:
  - "Lokal elfirma"
  - "Riktiga takläggare"
  - "Stödtjänster & Arbitrage"
  - "Batterilagring 50% avdrag"
  - "Totalentreprenad"
image: "https://images.unsplash.com/photo-1730807908064-c087959dd52c?auto=format&fit=crop&q=80&w=1600"
processSteps:
  - step: 1
    title: "Hembesök & Förutsättningar"
    description: "Vi tittar på tak, elcentral och diskuterar dina behov på plats."
  - step: 2
    title: "Kalkyl & Offert"
    description: "Du får en tydlig beräkning på produktion, besparing och kostnad."
  - step: 3
    title: "Installation"
    description: "Vi monterar och installerar. Vi sköter all kontakt med nätägaren och föranmälan."
  - step: 4
    title: "Driftstart"
    description: "Anläggningen besiktigas och tas i drift. Du kan börja producera egen el!"
taxDeduction: "gron15"
---
...
- **Egenanvändning:** Lagra solenergi på dagen och använd på kvällen.
